  ...
  render() {
    return(<main className="main-body">
      <img className="about-image" alt="the bearded lady and ringleader in a police lineup" src={lineup}></img>
        ...
        <p className="body-copy">Jason makes use of his art and design background to craft beautiful, accessible code in the form of websites and web apps with an emphasis on Visual and Performing Artists.</p>

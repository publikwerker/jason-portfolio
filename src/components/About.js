  ...
  render() {
    return(<main className="main-body">
      <img className="about-image" alt="the bearded lady and ringleader in a police lineup" src={lineup}></img>
        ...
        <p className="body-copy">Jason is a full-stack web developer, Fine Artist, and writer who draws still pictures and writes moving words. He is both congenial and tactful.</p>

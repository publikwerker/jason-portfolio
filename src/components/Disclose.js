  ...
  render() {
    return (
      ...
      {/* this will eventually be handled by a reactive header element that will swap out the logos according to page  */}
        ...
        <p>More than the sum of its parts*, this irreverent comic is the result of combining my loves of drawing, 'fringe' technologies, and all things space-related.</p>
        <img src={discloseLogo} className="disclose-logo" alt="A cartoon astronaut talking to a cartoon grey alien" />
        <p>A cheeky grey and a space-abiding programmer discuss the nature of reality.</p>
